...
namespace p2sp
{
    ...
    public:
        ...
        void QueryDownloadProgressByUrl(string url, boost::function<void(boost::int32_t , boost::int32_t)> result_handler);
        ...
        void SetRestPlayTimeByUrl(string url, boost::uint32_t rest_play_time);
